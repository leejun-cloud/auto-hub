...
export const TRANSLATIONS = {
  ko: {
    ...
    secSkillTitle: "즉시 적용 가능한 스킬",
    secSkillDesc: "AI 도구와 업무 흐름에 바로 붙여 쓰는 실행 가이드입니다.",
  ...
  en: {
    ...
    buyNow: "Buy Now",
    viewSubscription: "Start Subscription",
    ...
    secSkillTitle: "Ready-to-Use Skills",
    secSkillDesc: "Practical skill packs that plug into AI tools and workflows.",
