          ...
          <div className="flex items-center gap-4">
            {user ? (
              ...
              <>
                ...
                <button onClick={loginWithGoogle} className="bg-surface-container-low border border-outline-variant/30 text-on-surface-variant font-label-md text-label-md px-4 py-2.5 rounded-xl hover:opacity-90 active:scale-95 transition-all text-center flex items-center gap-1.5 btn-animate">
